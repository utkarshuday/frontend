      ...
      {URL === 'DOWN' ? (
        ...
        <>
          ...
          <p className='max-w-[38ch] lg:text-2xl text-base text-center mx-auto mt-5'>
            ...
            analytics platform. Whether you&apos;re a creator looking to grow
            your channel, a brand seeking to optimize your video strategy, or
            just curious about the data behind your favorite videos, we provide
            in-depth insights to help you succeed.
          </p>
          <Button
            onClick={() => inputFocus()}
